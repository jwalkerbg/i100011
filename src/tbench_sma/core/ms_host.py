...
class MShost:
    ...
    def ms_set_co_thr(self, value: int):
    ...
    def ms_set_temp_thr(self, value: int):
        return self.ms_command_send_uint16("TH", value)

    def ms_sensors_enable(self, sensor:int, operation:int):
    ...
    def ms_outputs_enable(self, output:int, operation:int):
    ...
    def ms_postventtime(self, value: int):
        return self.ms_command_send_uint16("PT", value)

    def ms_postlighttime(self, value: int):
        return self.ms_command_send_uint16("PL", value)

    def ms_co_interval(self, value: int):
        return self.ms_command_send_uint16("CI", value)

    def ms_auto_times(self, vent_toggle_time: int, vent_pause_time: int):
    ...
    def ms_set_phases(self, phase1: int, phase2: int, phase3: int, phase4: int, phase5: int):
    ...
    def ms_set_speed(self, speed: int):
        return self.ms_command_send_uint8("SX", speed)

    def ms_led_duties(self, duty0: int, duty1: int, duty2: int, duty3: int, duty4: int, operation: int):
        # duty0-4: 0-1023
        # duty0 = blue
        # duty1 = green
        # duty2 = red
    ...
    def ms_logs(self, log_level: int, log_module: int):
    ...
    def ms_set_mqtt(self, broker: str):
    ...
    def ms_output(self, output: int, operation: int):
    ...
    def ms_fan(self, fan: int, operation: int):
    ...
    def ms_set_fan_phase(self, fan: int, phase: int):
    ...
    def ms_fan_process(self, fan: int, operation: int, phase: int):
    ...
    def ms_leds(self, operation: int, leds: int):
    ...
    def ms_ota_update_version_only(self, version: str):
    ...
    def ms_setbaseurl(self, url: str):
        url_bytes = url.encode('ascii')
        data = bytearray(url_bytes)
        data = data.hex()
